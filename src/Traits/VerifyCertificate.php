...
namespace ZarulIzham\Fpx\Traits;
...
trait VerifyCertificate
{
	 ...
	 * @param string $data
	 *
	 * @throws \ZarulIzham\Fpx\Exceptions\InvalidCertificateException
	 * @return bool
	 */
	public function verifySign($checkSum, $data): bool
	{
		...
		$certificate = Storage::disk($disk)->get($dir.'/'.config('fpx.certificates.public_filename'));
	...
	public function getPublicKeyCert(): string
	{
		...
		$filename = config('fpx.certificates.private_filename');
