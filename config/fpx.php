...
return [
	...
	/**
	 * Database table names used by this package.
	 */
	'tables' => [
		'banks' => env('FPX_BANKS_TABLE', 'fpx_banks'),
		'fpx_transactions' => env('FPX_TRANSACTIONS_TABLE', 'fpx_transactions'),
	],
	...
	'certificates' => [
		...
		'private_filename' => env('FPX_PRIVATE_CERT_FILENAME', env('FPX_EXCHANGE_ID').'.key'),
		'public_filename' => env('FPX_PUBLIC_CERT_FILENAME', env('FPX_EXCHANGE_ID').'.cer'),
	],
